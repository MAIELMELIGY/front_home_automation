    ...
    return (
      <div>
        <section id="hero" classNmae="d-flex align-items-center">
          <div>
            {this.state.Robot
              .filter((smartloack) => smartloack.Name === "Robot")
              .map((Robot) => {
                return (
                  <div
                  ...
                  >
                  <div>
                  <img className="cover" src={Robot.img_description} />
                  </div>
                  <div class="row light-blue lighten-5 z-depth-4">
                  <div class="col-sm-3"> <img class="circle" src={Robot.img_slider}/> </div>
                  <div class="col-sm-9">
          ...
          <div class="row" id="sortable">
            <div class="col-md-3">
              {this.state.Product.filter(
                (Product) => Product.tag === "Robot"
              ).map((Product) => (
                <div class="card-sub" key={Product.id}>
                  <Link className="link" to={`/Robot/${Product.id}`}>
